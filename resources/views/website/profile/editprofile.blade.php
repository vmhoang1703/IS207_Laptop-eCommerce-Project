...
<body class="d-flex flex-column align-items-center">
  ...
  <div class="container-xxl  row">
    ...
    <div class="col-xxl-8 col-xxl-8 col-xl-12 col-lg-12">
      <!--  -->
      <form action="{{ route('profile.update', $user->user_id) }}" method="POST" id="edit-mode" class="  container-xxl container-xl container-lg box-infor d-flex flex-column gap-4">
        @csrf
        @method('PUT')
        ...
        <!-- <div class="row">
          <div class="first-name-and-email col-xxl-6 col-xl-12 d-lg-flex flex-column gap-4 pe-4 padding-right-mobile-12">
            <div class="form-item">
              ...
              <input type="text" class="form-control" id="custom-first-name" value="{{ $user->name }}">
            </div>
            <div class="form-item">
              <label for="custom-email" class="form-label">Email address</label>
              <input type="email" class="form-control" id="custom-email-last" value="{{ $user->email }}">
            </div>
          </div>
          <div class="last-name-and-address col-xxl-6 col-xl-12 d-lg-flex flex-column gap-4 ms-auto ps-4 padding-left-mobile-14 ">
            <div class="form-item">
              ...
              <input type="text" class="form-control" id="custom-last-name" value="{{ $user->name }}">
            </div>
            <div class="form-item">
              <label for="custom-email" class="form-label">Address</label>
              <input type="text" class="form-control" id="custom-address" value="{{ $user->address }}">
            </div>
          </div>
        </div> -->
        <div class="row">
          <div class="form-item">
            ...
            <input type="text" name="name" class="form-control" id="custom-first-name" value="{{ $user->name }}">
          </div>
        </div>
        <div class="row">
          <div class="form-item">
            <label for="custom-first-name" class="form-label">Email address</label>
            <input type="text" name="email" class="form-control" id="custom-first-name" value="{{ $user->email }}">
          </div>
        </div>
        <div class="row">
          <div class="form-item">
            <label for="custom-first-name" class="form-label">Address</label>
            <input type="text" name="address" class="form-control" id="custom-first-name" value="{{ $user->address }}">
          </div>
        </div>
        <div class="row">
          <div class="form-item">
            <label for="custom-first-name" class="form-label">Phone number</label>
            <input type="text" name="phone" class="form-control" id="custom-first-name" value="{{ $user->phone }}">
          </div>
        </div>
        <!-- <div class="row">
          <div class="form-item">
        ...
        <div class="btn-group  d-flex gap-3">
          <button id="reset-infor" onclick="location.href='/profile'" type="reset" class="btn btn-dark mobile-font-size-14">Cancel</button>
          <button id="save-infor" type="submit" class="btn btn-danger mobile-font-size-14">Save</button>
        </div>
      </form>
      <!--  -->
    </div>
