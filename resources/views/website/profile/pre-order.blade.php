...
<body class="d-flex flex-column align-items-center">
    ...
    <!--  nav mobile -->
    @component("components.profile_my-order_mobile_navbar")
    @endcomponent
    <div class="container-xxl container-xl container-lg container-md container-sm row">
        <div class="container-xxl container-xl container-lg container-md container-sm col-xxl-3 col-xl-3 col-lg-3">
            @component("components.profile_pre-order_navbar")
            @endcomponent
        </div>
        <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-12 col-sm-12">
            <div class="  p-5  container-xxl container-xl container-lg container-md container-sm box-infor d-flex flex-column gap-4">
                ...
                <div class="  d-flex flex-column  gap-3 ">
                    ...
                    @component("components.profile_cart_pre-order-page", ['order' => $order])
                    @endcomponent
                    @endforeach
                </div>
                        ...
                        <div class="modal-body">
                            <div class="container d-flex flex-column justify-content-center">
                                <div class="card-item row">
                                    ...
                                    <div class="  col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-8 d-flex flex-column gap-2 ">
                                ...
                                <div class=" order-status ">
                                    ...
                                    <div class="order-status-detail d-flex flex-column ">
                                        <div class=" detail-line row mt-2 ">
                                            <img class="col-xxl-1 col-xl-1 col-lg-1 col-md-1 col-sm-1  icon-status-order " src="{{ asset('img/check-box-shipping.svg')}} " alt="">
                                            <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-8 ps-auto d-flex flex-column  ">
                                                <h3 class="shipping-infor-title  text-start"> In delivery- 17/12 </h3>
                                                <div class="shipping-infor-site">Ga Sài Gòn </div>
                                            </div>
                                            <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-2 shipping-infor-time   text-end"> 15:20 PM</div>
                                        </div>
                                        <!--  -->
                                        <div class=" detail-line row mt-2 ">
                                            <img class="col-xxl-1 col-xl-1 col-lg-1 col-md-1 col-sm-1  icon-status-order " src="{{ asset('img/check-box-shipping.svg')}} " alt="">
