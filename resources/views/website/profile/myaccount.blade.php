...
<!--  -->
    <div class="container-xxl  row">
      ...
      <div class="  col-xxl-8 col-xl-12 col-lg-12">
        ...
        <div
  id="read-mode"
  class="container-xxl container-xl container-lg box-infor d-flex flex-column gap-4"
>
  <h2 class="box-infor-title">Your Profile</h2>
  <div class="row">
    <div
      class="first-name-and-email col-xxl-6 col-xl-12 d-lg-flex flex-column gap-4 pe-4 padding-right-mobile-12"
    >
      <div class="form-item">
        <label for="custom-first-name" class="form-label"
          >First name</label
        >
        <input
          type="text"
          class="form-control"
          id="custom-first-name"
          value="Minh Duc Hoang"
          required
          readonly
        />
      </div>
    ...
    <div
      class="last-name-and-address col-xxl-6 col-xl-12 d-lg-flex flex-column gap-4 ms-auto ps-4 padding-left-mobile-14 "
    >
      <div class="form-item">
        <label for="custom-first-name" class="form-label"
          >Last name</label
    ...
    <div class="form-item">
      ...
      <div class="password-line d-flex input-group">
        ...
        >
          <img
            class="show-password"
            src="{{asset('img/show-password-icon.svg')}}"
            alt=""
          />
          <img
            class="hide-password"
            src="{{asset('img/hide-password-icon.svg')}}"
            alt=""
          />
        </button>
      </div>
