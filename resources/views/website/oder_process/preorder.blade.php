        ...
        <div class=" padding-right-xl  col-xxl-6 col-xl-6 col-lg-12 col-md-12 col-sm-12 d-flex flex-column mt-4">
          ...
          <div class="form-custommer-infor">
            ...
            <div class="form-check  mb-3">
              <label class="form-check-label exclude text-mobile-size-14 " style="position: relative;"> Save this
                information for faster check-out next time
                <input class=" exclude form-check-input" type="checkbox" name="remember" checked="checked"> <span
          ...
          <div class=" infor-payment  d-flex flex-column mt-5 text-mobile-size-14 ">
            <div class="row mt-5 mb-3 margin-top-mobile-16">
              <div class="product-tite col-xxl-6 col-xl-6 col-lg-6 col-md-8 col-sm-8 col-8 d-flex ">
                <img src="https://via.placeholder.com/150" style="height: 65px; width: 65px; object-fit: cover;"
                  class="product-img ">
            ...
            <div class="row payment-method mt-3 d-flex align-items-center" data-bs-toggle="modal"
              data-bs-target="#exampleModal" id="paymentMethodBtn">
              <img id="method-img-main" class="col-xxl-1 col-xl-1 col-lg-1 col-md-1 img-mobile-40x40"
                style="width: 60px; height: 60px; object-fit: contain;" src="{{asset('img/payment-icon.svg')}}"
                alt="payment-icon">
                  ...
                  <div class="modal-body d-flex flex-column gap-3 ">
                    ...
                    <div id="method-pay-in-store" class="method-line d-flex  ">
                      <img class="method-img"
                        ...
                        style="width: 60px; height: 60px; object-fit: contain;" alt="Pay in store ">
                      <div class="method-name">Pay in store</div>
                    </div>
                    <div id="method-vnpay" class="method-line d-flex ">
                      <img class="method-img" src="https://cdn2.cellphones.com.vn/x/media/logo/gw2/vnpay.png"
                        style="width: 60px; height: 60px;object-fit: contain; " alt="VNPAY ">
                      <div class="method-name">VNPAY</div>
                    </div>
                    <div id="method-visa" class="method-line d-flex ">
                      <img class="method-img" src="https://cdn2.cellphones.com.vn/x/media/logo/gw2/onepay.png"
                        style="width: 60px; height: 60px;object-fit: contain; " alt="Visa ">
                      <div class="method-name">Visa/Master/JCB/Napas</div>
                    </div>
                    <div id="method-momo" class="method-line d-flex ">
                      <img class="method-img" src="https://cdn2.cellphones.com.vn/x/media/logo/gw2/momo_vi.png"
                        style="width: 60px; height: 60px;object-fit: contain; " alt=" MoMo ">
                      <div class="method-name">MoMo</div>
                    </div>
                    <div id="method-zalopay" class="method-line d-flex ">
                      <img class="method-img" src="https://cdn2.cellphones.com.vn/x/media/logo/gw2/zalopay.png"
                        style="width: 60px; height: 60px;object-fit: contain; " alt=" ZaloPay ">
            ...
            <div class="d-grid mt-4">
              <div class="row payment-method mt-3 d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#Toggle_succeed">
                <button type="button" class="btn btn-danger btn-preorder">Pre-order</button>
                <div
                  class="col-xxl-4 col-xl-4 col-lg-4 col-md-3 col-sm-3 col-3 text-end method-change text-end ms-auto">
                </div>
              </div>
            </div>
