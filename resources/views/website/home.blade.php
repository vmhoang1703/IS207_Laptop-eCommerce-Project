        ...
        <div class="contentP">
            ...
            <div class="BestSeller">
                ...
                <div class="product-list">
                    ...
                    <div class="Fa">
                        <h1 class="pro-textL">Favorite Product</h1>
                    ...
                    <div class="tablenewarrival">
                        ...
                        <div style="margin-left: -30px;">
                            <table>
                                <tr>
                                    <td class="TNAHeader">
                                        <a class="pro-textL" style="margin-left: 30px;"> New Arrival</a>
                                    </td>
                                </tr>
                            </table>
            ...
            <div class="BestSeller">
                ...
                <div class="Fa">
                    <h1 class="pro-textL">Testimonials</h1>
                </div>
                <div class="Feedback">
                    <table style="padding: 30px 20px; font-size: 20px; margin: 0px auto">
                        <tr>
                            <!-- FeedbackCard -->
                            @component('components.feedback-card')
                            @endcomponent
                            @component('components.feedback-card')
                            @endcomponent
                            @component('components.feedback-card')
