...
<div class=" line-item  d-flex align-items-center row mt-3 container-xxl">
    ...
    <label for="check-box-item" class=" form-check-label row col-xxl-11 border-box-item  d-flex align-items-center  pe-5 ps-5">
        <a href="#" class=" product-infor d-flex gap-2 col-xxl-4 table-title text-start">
            <img class="product-img" src="../Oder_Proces/Screen_3/18051e29a0086c873a703c6861f2eefb.jpg" alt="">
            <h3 class="product-name text-start"> Dell XPS 9710 17 inch Core i7 </h3>
        </a>
        <div class="col-xxl-3 table-title text-start "> $650 </div>
        ...
        <div class="col-xxl-2 table-title text-end  "> $2000</div>
    </label>
</div>
