      ...
      <div class="collapse navbar-collapse" id="navbarNav-mobile">
        <ul class="navbar-nav d-flex gap-4">
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle mobile-font-size-14" href="#" id="nav-manage-account" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              Manage My Account
            </a>
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle mobile-font-size-14  active" href="#" id="nav-my-oder" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              My Orders
            </a>
